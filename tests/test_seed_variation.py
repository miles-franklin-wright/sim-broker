...
def test_different_seeds_produce_different_orders(tmp_path):
    day = "2025-02-02"
    d1 = generate_day(day, seed=1, out_root=tmp_path / "s1", overwrite=False, n_symbols=15)
    d2 = generate_day(day, seed=2, out_root=tmp_path / "s2", overwrite=False, n_symbols=15)
